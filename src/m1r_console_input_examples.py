...
###############################################################################
# : 2.  Read and run this program.  Then do the following problems,
...
#      Write your line here:
#            x =float('Enter a floating point: "))
...
#           If you enter anything other than an integer you get the error ValueError: invalid literal for int() with base 10: '2.5'
